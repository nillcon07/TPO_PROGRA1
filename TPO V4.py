...
def agregar_envio(contador1, matriz1): #Contador sirve para q se hagan las iteraciones, las toma cuando llama a codigo_envio
    ...
    matriz1[4].append(datetime.datetime.now().date())
    ...
    if matriz3[0] == []:
        ...
        match int(opcion):
            ...
            case 3:
                ...
                seleccion = input("- Pendiente\n- Despachado\n- En camino \n- Entregado\n- Cancelado \n- Devuelto\n\nIngrese el nombre estado el cual desea ver el listado: ").capitalize()

                if seleccion not in estados:            
                    print("Estado ingresado incorrecto")

                else:
                    print("Lista de pedidos segun estado de envio 📦 : ")
                    print("-"*60)
