...
def validar_horario(msj="Ingrese la consulta: "):
    ...
    while True:
        ...
        try:
            ...
            if not (1 <= d <= 31 and 1 <= m <= 12 and 2000 <= y <= 9999):
                raise ValueError
...
def preguntar_continuar():
    ...
    while ingreso != "si" and ingreso != "no":
        ingreso = input("Ingreso inválido. Si/No: ").lower()
    return ingreso == "si"
        ...
        if volver:
            if preguntar_continuar():
                try:
                    ...
                    print(f"Maximo de llamadas recursivas cometidas: {e}")
        ...
        match opcion:
            ...
            case 2: ###POR FECHA###
                ...
                if seleccion == "año":
                    ...
                    valor = validar_opciones(valor,2000,9999)
