        ...
        match int(opcion):
            case 1: #LISTAR TODO#
                ...
                for lista in matriz3:
                    print(matriz3[lista], end=' | ') #imprime todos los pedidos del sistema de forma estetica
                print()
            ...
            case 2:
                ...
                for f in range(len(matriz3)):
                    for c in range(len(matriz3[0])):
                        print(matriz3[f],end=' | ') #imprime todos los pedidos del sistema de forma estetica
        ...
        if matriz4[0][i] == codigo3:
            ...
            if seguridad == 's':
                ...
                if opcion == 0:
                    ...
                    matriz4[3] = "Despachado"
                elif opcion == 3:
                    matriz4[3] = "En camino"
                elif opcion == 4:
                    matriz4[3] = "Entregado"
                elif opcion == 5:
                    if matriz4[3] == "Entregado":
                ...
                if opcion != 0 and "Devuelto" not in matriz4[3][i]:  # Solo mostrar si no se canceló o no fue devuelto
                    ...
                    print(f" ✅ Pedido actualizado: {matriz4[0][i]} | {matriz4[1][i]} | {matriz4[2][i]} | {matriz4[3][i]}")
                break
            elif seguridad == 'n':
...
while True:
    ...
    match opcion:
        ...
        case 3:
            ...
            listado = input("\nEscoja una opcion: ")
            while not(listado.isdigit() and 1<=int(listado)<=3): 
                listado=input("Opcion incorrecta, recuerde que debe ser un numero entre 1 y 3 (incluyendo), escoja una opcion:")
            historial_envios(sistema,listado)
        case 4:
