...
def agregar_envio(contador1, matriz1): #Contador sirve para q se hagan las iteraciones, las toma cuando llama a codigo_envio
    ...
    print(":".join(map(str, matriz1[4][contador1 - 1][3: ])))
    print()
    ...
    if tipo_elegido == 1:
        ...
        if matriz2[0] == []:
            ...
            if encontrado:
                ...
                print(":".join(map(str, matriz2[4][indice][3: ])))
                print()
            else:
        ...
        match int(opcion):
            case 1: #LISTAR TODo#
                ...
                for i in range(total):
                    ...
                    print(":".join(map(str, matriz3[4][i][3: ])))
            ...
            while True:
                ...
                if seguridad == "si":
                    ...
                    if opcion != 0 and "Devuelto" not in matriz4[3][i]:  # Solo mostrar si no se canceló o no fue devuelto
                        ...
                        print(":".join(map(str, matriz4[4][i][3: ])))
                        print()
                    break
                elif seguridad == "no":
...
def devoluciones(matriz5): 
    ...
    encontrado = False
    for c in range(len(matriz5[0]) - 1):
